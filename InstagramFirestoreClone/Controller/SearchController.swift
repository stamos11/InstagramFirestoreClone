...
//            let usernameContains = user.username.uppercased().contains(searchText)
//            let fullnameContains = user.fullname.uppercased().contains(searchText)
//            return usernameContains || fullnameContains
//        })
